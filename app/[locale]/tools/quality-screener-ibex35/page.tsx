...
export default function QualityScreenerIbex35Page() {
  return (
    <ScreenerReport
      ...
      jsonLdDescription="Weekly IBEX 35 screen on quality fundamentals (ROE, ROA, P/E) and momentum (RSI, MA50), with an AI-generated research report on the companies that pass."
